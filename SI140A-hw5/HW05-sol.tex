...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item ...
        \item If treasure in realm 9, then we need to ask 9 questions. \\
    \end{enumerate}
    ...
    Then we have that: 
    $$E(X_i) = 1 * \dfrac{1}{9} + 2 * \dfrac{1}{9} + ... + 9 * \dfrac{1}{9} = 5$$
    \item 
    By using the bisection method, as for cases that treasure in realm $\in [1, 5]$, will have probability of $\dfrac{5}{9}$ to continue find, as for realm $\in [6, 9]$, will have probability of $\dfrac{4}{9}$, to continue find. As for the first part, then 
\end{enumerate}
